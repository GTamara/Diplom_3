...
class ConstructorPageLocators:
    ...
    SPECIFIED_CATEGORY_INDEXED_INGREDIENT_ITEM = \
        By.XPATH, INDEXED_CATEGORY_SECTION[1] + '//a[contains(@class, "BurgerIngredient_ingredient_")][{}]'
    # INGREDIENTS_CONTAINER = By.XPATH, '//div[contains(@class, "BurgerIngredients_ingredients__menuContainer_")]'
    ...
    INGREDIENT_POPUP = By.XPATH, '//section[contains(@class, "Modal_modal_opened_")]'
    INGREDIENT_TITLE_WITHIN_POPUP = By.XPATH, INGREDIENT_POPUP[1] + '//p[contains(@class, "text_type_main")]'
    INGREDIENT_POPUP_CLOSE_BTN = By.XPATH, INGREDIENT_POPUP[1] + '//button[contains(@class, "_modal__close_")]'
    ...
    SET_ORDER_BUTTON = By.XPATH, '//button[contains(text(), "Оформить заказ")]'

    NEW_ORDER_POPUP = By.XPATH, '//section[contains(@class, "Modal_modal_opened_")]'
    NEW_ORDER_POPUP_ORDER_NUMBER = By.XPATH, NEW_ORDER_POPUP[1] + '//h2[contains(@class, "ext_type_digits")]'
    NEW_ORDER_POPUP_ORDER_TITLE = By.XPATH, NEW_ORDER_POPUP[1] + '//p[contains(text(), "идентификатор заказа")]'
